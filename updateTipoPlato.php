...
$tipoPlato = $_POST['descripcion'];
$sql = "UPDATE tipos SET descripcion = '$tipoPlato' WHERE codTipo = '$codTipo'";
...
<head>
    ...
    <title>Actualizar tipo de plato</title>
</head>

<body>
    <div class="container" style="display: flex; flex-direction: column;align-items: center;">
        <div class=" row">
            <h3>Actualizar tipo de plato</h3>
        </div>
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                <?php
                if ($resultado) { ?>
                    <h3>tipo de plato actualizado</h3>
                <?php
                } else { ?>
