...
$codCat = $_GET['codCat'];
$sql = "SELECT * FROM categorias WHERE codCategoria = '$codCat'";
...
<body>
    <div class="container" style="display: flex; flex-direction: column;align-items: center;">
        ...
        <div class="card" style="width: 20rem;">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="updateCat.php" autocomplete="off">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-append input-group-text">
                                <span class="fas fa-users-cog"></span>
                            </div>
                            <input type="text" class="form-control" name="codCategoria" value="<?php echo $row['codCategoria']; ?>" readonly>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-append input-group-text">
                                <span class="fas fa-users-cog"></span>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2">
                            <a href="categorias" class="btn btn-default">Regresar</a>
