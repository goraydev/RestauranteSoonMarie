...
$consulta1 = "SELECT * FROM v_empleados";
...
while ($mostrar = $resultado1->fetch_array(MYSQLI_ASSOC)) {
    $pdf->Cell(20);
    $pdf->Cell(18, 6, $mostrar['DNI'], 1, 0, 'C', 0);
    $pdf->Cell(38, 6, utf8_decode($mostrar['Empleado']), 1, 0, 'C', 0);
    $pdf->Cell(20, 6, $mostrar['numTelefono'], 1, 0, 'C', 0);
    $pdf->Cell(35, 6, utf8_decode($mostrar['direccion']), 1, 0, 'C', 0);
    $pdf->Cell(38, 6, $mostrar['categoria'], 1, 1, 'C', 0);
}
$pdf->Output();
