...
$especialidad = $_POST['descripcion'];
$sql = "UPDATE especialidades SET descripcion = '$especialidad' WHERE codEspecialidad = '$codEspecialidad'";
    ...
    <div class="container" style="display: flex; flex-direction: column;align-items: center;">
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                <?php
                if ($resultado) { ?>
                    <h3>especialidad actualizada</h3>
                <?php
                } else { ?>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2">
                        <a href="especialidades" class="btn btn-primary">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
